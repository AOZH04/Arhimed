(() => {
    ...
    function initSliders() {
        if (document.querySelector(".reviews__slider")) var portfolioMaxSlider = new core(".reviews__slider", {
        ...
        if (document.querySelector(".portfoliomin__slider")) var portfolioMinSlider = new core(".portfoliomin__slider", {
            modules: [ Navigation, Pagination, Scrollbar, Keyboard, Mousewheel, Autoplay, EffectFade, EffectFlip, EffectCube, EffectCoverflow, Grid ],
            observer: true,
            observeParents: true,
            observeSlideChildren: true,
            ...
            watchOverflow: true,
            navigation: {
                prevEl: ".portfoliomin__prev",
                nextEl: ".portfoliomin__next"
            },
            keyboard: {
                enabled: true,
                onlyInViewport: true,
        ...
        if (document.querySelector(".portfoliomax__slider")) portfolioMaxSlider = new core(".portfoliomax__slider", {
            modules: [ Navigation, Pagination, Scrollbar, Keyboard, Mousewheel, Autoplay, EffectFade, EffectFlip, EffectCube, EffectCoverflow, Grid ],
            observer: true,
            observeParents: true,
            observeSlideChildren: true,
        ...
        portfolioMaxSlider.on("slideChange", (function() {
            var slideIndex = portfolioMaxSlider.realIndex;
            portfolioMinSlider.slideTo(slideIndex);
        }));
        portfolioMinSlider.on("slideChange", (function() {
            var slideIndex = portfolioMinSlider.realIndex;
            portfolioMaxSlider.slideTo(slideIndex);
        }));
    }
